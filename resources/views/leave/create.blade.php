...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4" style="background-color: #d9f3ff; padding: 15px; border-radius: 5px;">
        <h1 class="h2">Add New Leave Type</h1>
    ...
    <div class="card" style="border: 1px solid #87CEEB; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        <div class="card-header text-white" style="background-color: #007bff;">
            <h5 class="mb-0">Create Leave Type</h5>
        </div>
        <div class="card-body" style="background-color: #f8f9fa;">
            <form method="POST" action="{{ route('leave-types.store') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="LeaveTypeName" name="LeaveTypeName" class="form-control @error('LeaveTypeName') is-invalid @enderror" value="{{ old('LeaveTypeName') }}" required>
                    @error('LeaveTypeName')
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="MaxLeaveDays" name="MaxLeaveDays" class="form-control @error('MaxLeaveDays') is-invalid @enderror" value="{{ old('MaxLeaveDays') }}" required>
                    @error('MaxLeaveDays')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="MinServiceYears" name="MinServiceYears" class="form-control @error('MinServiceYears') is-invalid @enderror" value="{{ old('MinServiceYears') }}" required>
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn btn-success w-100">Create Leave Type</button>
            </form>
        </div>
    </div>
</div>
